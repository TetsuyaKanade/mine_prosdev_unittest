...
describe('Letter Score should be "O" when student scores 95-100' , () => {
  ...
  it('When user has a score of 99 then it should return "O"', () => {
    // Arrange
  ...
  it('When user has a score of 98 then it should return "O"', () => {
    // Arrange
  ...
  it('When user has a score of 97 then it should return "O"', () => {
    // Arrange
  ...
  it('When user has a score of 96 then it should return "O"', () => {
    // Arrange
  ...
  it('When user has a score of 95.01 then it should return "O"', () => {
    // Arrange
...
describe('Letter Score should be "V" when student scores 90.00-94.99', () => {
  ...
  it('When user has a score of 93.5 then it should return "V', () => {
    // Arrange
  ...
  it('When user has a score of 92.8 then it should return "V', () => {
    // Arrange
  ...
  it('When user has a score of 91.02 then it should return "V', () => {
    // Arrange
...
describe('Letter Score should be "G" when student scores 85.00-89.99', () => {
  ...
  it('When user has a score of 88.94 then it should return "G', () => {
    // Arrange
  ...
  it('When user has a score of 87.65 then it should return "G', () => {
    // Arrange
  ...
  it('When user has a score of 86.42 then it should return "G', () => {
    // Arrange
...
describe('Letter Score should be "S" when student scores 80.00-84.99', () => {
  ...
  it('When user has a score of 83.21 then it should return "S"', () => {
    // Arrange
  ...
  it('When user has a score of 82.64 then it should return "S"', () => {
    // Arrange
  ...
  it('When user has a score of 81.98 then it should return "S"', () => {
    // Arrange
...
describe('Letter Score should be "N" when student score 75.00-79.99', () => {
  ...
  it('When user has a score of 78.87 then it should return "N', () => {
    // Arrange
  ...
  it('When user has a score of 77.77 then it should return "N', () => {
    // Arrange
  ...
  it('When user has a score of 76.54 then it should return "N', () => {
    // Arrange
...
describe('Letter Score should be "D" when student score 74.99 and below', () => {
  ...
  it('When user has a score of 73.21 then it should return "D', () => {
    // Arrange
  ...
  it('When user has a score of 72.12 then it should return "D', () => {
    // Arrange
  ...
  it('When user has a score of 71.98 then it should return "D', () => {
    // Arrange
  ...
  it('When user has a score of 70 then it should return "D', () => {
    // Arrange
  ...
  it('When user has a score of 0 then it should return "D', () => {
    // Arrange
